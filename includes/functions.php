<?php
	...
	function confirm_query($result_set) {
		...
		} // check if query statement failed
	}
	...
	// navigation needs two arguments:
	// currently subject array or null
	// currently page array or null
	...
	function find_admin_by_id($admin_id) {
		...
		confirm_query($admin_set);
		if ($admin_set) {
			return mysqli_fetch_assoc($admin_set);
		} else {
			return null;
		}
	}
	...
	function generate_salt($length) {
		...
		//Truncate string to a correct length
